...
/* package currying-0.1.0.0 */
#ifndef VERSION_currying
#define VERSION_currying "0.1.0.0"
#endif /* VERSION_currying */
#ifndef MIN_VERSION_currying
#define MIN_VERSION_currying(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_currying */
...
#define CURRENT_COMPONENT_ID "currying-0.1.0.0-EJJWDgj8eKw4udAkXlFFnF-currying"

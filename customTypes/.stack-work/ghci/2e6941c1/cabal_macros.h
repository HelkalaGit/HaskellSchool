...
/* package customTypes-0.1.0.0 */
#ifndef VERSION_customTypes
#define VERSION_customTypes "0.1.0.0"
#endif /* VERSION_customTypes */
#ifndef MIN_VERSION_customTypes
#define MIN_VERSION_customTypes(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_customTypes */
...
#define CURRENT_COMPONENT_ID "customTypes-0.1.0.0-5IQVOw7sekp3mribDEUAhi-customTypes"
